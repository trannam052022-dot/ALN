...
- **Bốc Chip May Mắn (thêm 23/07/2026)** — trò chơi phản xạ riêng biệt, KHÔNG dùng chung điều kiện mở khoá với vòng quay tuần: mở khoá **vĩnh viễn** ngay sau khi hoàn thành ≥1 nhiệm vụ bất kỳ lần đầu (tức chỉ cần `users/{sđt}` tồn tại), sau đó chơi **1 lượt/ngày**. 4 ô chip nhãn 1.000đ/2.000đ/5.000đ/10.000đ nhưng số Gạch thật là **5/10/25/50** (`CHIP_PRIZES` trong `functions/ctvGame.js`, PHẢI khớp `chip-cell` trong `ctv_dashboard.html`) — thấp hơn tỷ lệ quy đổi gốc 1 Gạch=100đ (lẽ ra là 10/20/50/100) vì tính lại thấy chi phí/ngày quá cao nếu chơi đều mỗi ngày, xem chi tiết ở mục "Đổi Gạch CTV" phần dưới. Trọng số xuất hiện GIẢM DẦN theo giá trị (55/30/12/3 — chip cao vừa hiếm vừa cửa sổ trúng ngắn 800→250ms) để độ khó tăng đúng như yêu cầu ban đầu.
