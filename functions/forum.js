...
function hoiKtsBank() {
  ...
  return [
    ...
    { asker:"Chị Thảo Vy · Q.Tân Bình", qh:3, title:"Xin phép xây dựng nhà ở cần hồ sơ gì, mất bao lâu?",
      q:"Em định khởi công tháng sau mà chưa rõ hồ sơ xin phép cần gì, nộp ở đâu và bao lâu thì có giấy phép ạ.",
      ans:[
        {k:KP.hphuc, d:D[0], h:6, best:true, t:"Bộ hồ sơ cơ bản gồm: đơn xin phép xây dựng, giấy tờ đất (sổ đỏ/sổ hồng), bản vẽ xin phép (mặt bằng, mặt đứng, mặt cắt, móng — do KTS có chứng chỉ hành nghề ký), và bản cam kết an toàn nếu sát nhà liền kề. Nộp tại UBND quận/huyện nơi có đất. Thời gian xử lý theo quy định thường 15-20 ngày làm việc nếu hồ sơ hợp lệ ngay từ đầu — hồ sơ thiếu/sai sẽ bị trả về làm mất thêm thời gian, nên nhờ KTS chuẩn bị đúng ngay từ đầu là quan trọng nhất."},
        {k:KP.truong, d:D[2], h:2, t:"Đúng vậy chị, nên nộp sớm hơn kế hoạch khởi công ít nhất 1 tháng để dự phòng trường hợp cần bổ sung giấy tờ."},
      ] },
    { asker:"Anh Lâm · Trảng Bàng", qh:2, title:"Xây nhà cấp 4 có cần bản vẽ kết cấu riêng không hay chỉ cần bản vẽ xin phép?",
      q:"Em xây nhà cấp 4 đơn giản 1 tầng thôi, nhà thầu bảo không cần vẽ kết cấu cho tốn tiền. Có đúng không ạ?",
      ans:[
        {k:KP.khanh, d:D[0], h:7, best:true, t:"Kể cả nhà cấp 4 vẫn nên có bản vẽ kết cấu tối thiểu (móng, đà, cột nếu có) anh ạ — vì nó quyết định kích thước sắt thép, mác bê tông đúng với tải trọng thật của công trình, tránh 2 thái cực: làm dư gây lãng phí, hoặc làm thiếu gây nứt/lún về sau. Chi phí phần này không nhiều so với rủi ro nếu làm sai kết cấu."},
        {k:KP.viet, d:D[2], h:2, t:"Em từng thấy nhà cấp 4 làm ẩu móng, vài năm sau nứt tường khắp nơi vì đất yếu mà không khảo sát trước. Bỏ qua bước này rủi ro thật đó anh."},
      ] },
    { asker:"Chị Kim Yến · Q.8", qh:3, title:"Gạch ốp phòng tắm loại nào chống trơn trượt tốt nhất?",
      q:"Nhà em có người lớn tuổi, sợ trơn trượt trong phòng tắm nguy hiểm. Nên chọn gạch gì ạ?",
      ans:[
        {k:KP.duong, d:D[0], h:5, best:true, t:"Chị ưu tiên gạch có chỉ số chống trượt (thường ghi trên bao bì dạng R9-R11, số càng cao càng nhám/an toàn) cho sàn phòng tắm, đặc biệt khu vực tắm đứng. Với nhà có người lớn tuổi, nên chọn R10 trở lên và tránh tuyệt đối gạch bóng gương cho sàn ướt."},
        {k:KP.nhan, d:D[2], h:2, t:"Thêm nữa: làm sàn phòng tắm dốc nhẹ về phễu thoát, và có thanh vịn gần khu vực tắm — kết hợp với gạch nhám thì an toàn hơn nhiều cho người lớn tuổi."},
      ] },
    { asker:"Anh Quang · Củ Chi", qh:2, title:"Cầu thang xương cá và cầu thang bê tông đổ, loại nào tiết kiệm diện tích hơn?",
      q:"Nhà em diện tích hẹp, đang cân nhắc giữa 2 loại cầu thang này. Loại nào tiết kiệm không gian hơn ạ?",
      ans:[
        {k:KP.dang, d:D[0], h:4, t:"Cầu thang xương cá (bậc thang gắn trực tiếp lên dầm giữa, không có đế bê tông đặc) thường nhẹ và trông thoáng, tạo cảm giác ít choán diện tích hơn về thị giác. Cầu thang bê tông đổ đặc thì chắc chắn, chịu lực tốt nhưng nhìn nặng hơn."},
        {k:KP.quan, d:D[2], h:5, best:true, t:"Về diện tích SÀN chiếm dụng thì 2 loại gần như tương đương (cùng chiều rộng, chiều dài bậc theo tiêu chuẩn) — khác biệt chính là cảm giác thị giác và chi phí (xương cá thường đắt hơn vì gia công phức tạp). Nếu mục tiêu là 'nhìn nhẹ nhàng, thoáng' cho nhà nhỏ thì xương cá lợi thế hơn hẳn."},
      ] },
    { asker:"Chị Phương Anh · Nhơn Trạch", qh:4, title:"Nhà có tầng hầm/bán hầm cần lưu ý gì để chống thấm ngược?",
      q:"Em định làm tầng hầm để xe, nghe nói thấm ngược (nước ngầm đẩy vào) khó xử lý hơn thấm thường. Cần chú ý gì từ khâu thiết kế ạ?",
      ans:[
        {k:KP.hphuc, d:D[0], h:7, best:true, t:"Đúng vậy chị, chống thấm ngược khó và tốn hơn nhiều so với thấm bề mặt thường vì áp lực nước ngầm liên tục đẩy vào. Từ khâu thiết kế cần: (1) lớp chống thấm toàn bộ vách + đáy hầm (không chỉ quét mà cần màng chống thấm dán/khò); (2) tính khả năng mực nước ngầm khu vực đó qua khảo sát địa chất; (3) có hệ thống bơm hút nước ngầm dự phòng dưới đáy hầm (hố ga bơm tự động) phòng trường hợp nước vẫn rò rỉ ít."},
        {k:KP.son, d:D[2], h:2, t:"Nhà bạn em làm hầm gần sông, phải làm thêm lớp bentonite chống thấm bên ngoài vách hầm mới yên tâm — khu nào gần nguồn nước nên hỏi kỹ KTS phương án phù hợp."},
      ] },
    { asker:"Anh Trung Kiên · Bến Cát", qh:3, title:"Lắp điện mặt trời áp mái có cần gia cố kết cấu mái không?",
      q:"Em muốn lắp điện năng lượng mặt trời sau này. Có cần thiết kế mái chịu lực thêm ngay từ đầu không hay lắp lúc nào cũng được ạ?",
      ans:[
        {k:KP.nson, d:D[0], h:6, best:true, t:"Nên báo KTS ngay từ đầu anh ạ, dù lắp sau vài năm. Tấm pin + khung đỡ có tải trọng đáng kể, mái/sàn mái cần được tính kết cấu chịu thêm tải này từ lúc thiết kế — lắp sau mà mái không tính trước dễ phải gia cố tốn kém hoặc rủi ro về lâu dài. Chỉ cần báo trước ý định, KTS thiết kế dư tải một chút là đủ, không tốn thêm nhiều."},
        {k:KP.klong, d:D[2], h:2, t:"Đúng, với lại nên chừa sẵn đường ống/máng kỹ thuật dẫn dây điện từ mái xuống tủ điện luôn từ lúc xây, đỡ phải đi dây nổi xấu về sau."},
      ] },
    { asker:"Chị Bích Thủy · Q.7", qh:2, title:"Chọn màu sơn ngoại thất sao cho hợp phong thủy mà không bị lỗi thời?",
      q:"Em muốn màu sơn vừa hợp tuổi/mệnh vừa nhìn hiện đại, không sợ vài năm sau lỗi mốt. Có gợi ý nào không ạ?",
      ans:[
        {k:KP.linh, d:D[0], h:5, best:true, t:"Cách dung hòa hay dùng: chọn 1 màu chủ đạo trung tính hợp mệnh làm tổng thể (be, xám sáng, trắng ngà... đều dễ phối hợp phong thủy và không lỗi thời), rồi nhấn thêm 1-2 điểm nhấn màu theo mệnh ở chi tiết nhỏ hơn (cổng, viền cửa, mảng tường phụ) — vừa đủ ý nghĩa phong thủy vừa không sợ toàn bộ mặt tiền bị 'cũ' theo trend màu nhất thời."},
        {k:KP.duy, d:D[2], h:2, t:"Màu trung tính cũng dễ bán lại nhà hơn nếu sau này có nhu cầu, nhiều người kỹ tính về màu sắc theo gu riêng."},
      ] },
    { asker:"Anh Việt Hoàng · Long Khánh", qh:3, title:"Biệt thự sân vườn nên chừa bao nhiêu % diện tích đất cho cây xanh?",
      q:"Đất em rộng 300m², định xây biệt thự. Nên chừa bao nhiêu đất làm sân vườn cho hợp lý, không quá ít cũng không lãng phí ạ?",
      ans:[
        {k:KP.tri, d:D[0], h:6, best:true, t:"Không có con số cứng anh ạ vì còn tùy quy định mật độ xây dựng của khu đất (thường 40-70% tùy khu vực, tra được trong sổ quy hoạch/giấy phép), nhưng kinh nghiệm thực tế: chừa tối thiểu 20-30% cho sân vườn + lối đi là đã đủ cảm giác thoáng và có chỗ trồng cây bóng mát. Quan trọng hơn là VỊ TRÍ chừa xanh — nên tập trung phía đón nắng/gió tốt thay vì rải mỏng khắp nơi."},
        {k:KP.cuong, d:D[2], h:2, t:"Đồng ý, sân vườn tập trung 1 khu lớn đẹp và hữu dụng hơn nhiều so với chia nhỏ vụn khắp đất."},
      ] },
    { asker:"Chị Hồng Nhung · Trảng Bom", qh:2, title:"Chống nóng cho sân thượng/tầng áp mái bằng vật liệu gì hiệu quả nhất?",
      q:"Tầng trên cùng nhà em nóng kinh khủng vào buổi trưa hè. Có cách nào giảm nhiệt hiệu quả mà không quá tốn kém ạ?",
      ans:[
        {k:KP.thinh, d:D[0], h:7, best:true, t:"Vài lớp chống nóng hay kết hợp, từ rẻ đến hiệu quả cao: (1) sơn chống nóng phản xạ nhiệt cho mái/sân thượng — rẻ, dễ làm, hiệu quả vừa phải; (2) lát gạch/tấm cách nhiệt (gạch block rỗng, tấm xps) lên sàn mái trước khi chống thấm — hiệu quả rõ rệt hơn; (3) trồng cây/làm giàn dây leo che nắng trực tiếp cho mảng tường/mái hướng Tây. Kết hợp 2 trong 3 cách là giảm nhiệt đáng kể mà chi phí hợp lý."},
        {k:KP.nhat, d:D[2], h:2, t:"Nhà em làm thêm mái tôn giả (mái che phụ cách mái thật khoảng 20-30cm, có khe thoáng khí) phía trên sân thượng, hiệu quả chống nóng bất ngờ luôn."},
      ] },
    { asker:"Anh Tấn Đạt · Q.Bình Tân", qh:2, title:"Máy lạnh âm trần hay treo tường, cái nào ảnh hưởng thiết kế trần nhiều hơn?",
      q:"Em đang phân vân lắp máy lạnh âm trần cho gọn hay treo tường cho đỡ tốn. Loại nào cần lưu ý gì khi thiết kế trần nhà ạ?",
      ans:[
        {k:KP.gbao, d:D[0], h:4, t:"Máy lạnh âm trần cần khoảng trần giả đủ sâu (thường tối thiểu 25-30cm) để giấu dàn lạnh + ống đồng + ống thoát nước, nên phải báo KTS ngay từ đầu để tính cao độ trần phù hợp. Treo tường thì đơn giản hơn, không ảnh hưởng nhiều đến trần, nhưng dàn nóng/dây điện đi ngoài nhìn kém gọn hơn."},
        {k:KP.phuc, d:D[2], h:5, best:true, t:"Bổ sung góc thiết kế: nếu chọn âm trần, ngoài cao độ trần thì cần tính luôn đường ống thoát nước ngưng có độ dốc về đúng hướng, và vị trí dàn nóng đặt ở đâu (sân thượng/hộp kỹ thuật) để đường ống gas không quá dài. Nên chốt phương án điều hòa SỚM trong giai đoạn thiết kế, đổi ý sau khi đổ trần thạch cao sẽ rất mất công."},
      ] },
    { asker:"Chị Ánh Tuyết · Long Thành", qh:3, title:"Cải tạo nhà cấp 4 cũ lên thêm 1 tầng, móng cũ có chịu được không?",
      q:"Nhà cấp 4 ba mẹ để lại xây khá lâu rồi, em muốn nâng thêm 1 tầng. Làm sao biết móng cũ có chịu tải nổi không ạ?",
      ans:[
        {k:KP.quan, d:D[0], h:8, best:true, t:"Đây là việc BẮT BUỘC phải khảo sát hiện trạng kỹ trước khi quyết định chị ạ — không thể đoán bằng mắt thường. Cần: (1) kiểm tra hồ sơ móng cũ nếu còn giữ (loại móng, kích thước); (2) khảo sát thực tế kết cấu hiện hữu (cột, móng, dầm) xem có vết nứt/xuống cấp không; (3) tính toán lại tải trọng nếu thêm 1 tầng. Nhiều trường hợp móng cũ chịu được nếu gia cố thêm (bổ sung cọc, mở rộng đế móng), nhưng cũng có trường hợp phải đập bỏ làm lại hoàn toàn — không có câu trả lời chung, phải khảo sát đúng nhà chị mới biết được."},
        {k:KP.tuan, d:D[2], h:2, t:"Đúng vậy, tuyệt đối đừng nâng tầng theo cảm tính hay theo kinh nghiệm nhà hàng xóm — mỗi nền móng một khác."},
      ] },
    { asker:"Anh Hữu Nghị · Tân Uyên", qh:2, title:"Đất nhà em sát bên là đất trống chưa xây, cần lưu ý gì khi thiết kế?",
      q:"Bên cạnh đất em hiện là đất trống, chưa biết chủ đất đó sau này xây gì. Thiết kế nhà em có cần tính trước gì không ạ?",
      ans:[
        {k:KP.nam, d:D[0], h:5, best:true, t:"Có vài điểm nên cân nhắc trước anh nhé: (1) cửa sổ/ban công hướng về phía đất trống đó nên thiết kế linh hoạt (có thể che chắn sau này) vì không biết công trình bên đó cao bao nhiêu; (2) tường giáp ranh nên xây đúng ranh giới, có hồ sơ đo đạc rõ ràng tránh tranh chấp sau này khi họ xây; (3) hệ thống thoát nước không nên xả trực tiếp qua phần đất trống đó."},
        {k:KP.huy, d:D[2], h:2, t:"Thêm: nên giữ lại biên bản/hồ sơ ranh giới đất rõ ràng phòng khi sau này họ xây sát vách, tránh cãi nhau về ranh đất."},
      ] },
    { asker:"Chị Diễm My · Q.Bình Chánh", qh:2, title:"Cửa cổng sắt hay cửa nhôm đúc, loại nào bền hơn cho nhà mặt tiền?",
      q:"Em đang chọn cổng cho nhà, phân vân giữa sắt uốn truyền thống và nhôm đúc kiểu mới. Loại nào bền và ít bảo trì hơn ạ?",
      ans:[
        {k:KP.khoa, d:D[0], h:4, t:"Nhôm đúc có ưu điểm không gỉ sét (khác hẳn sắt), gần như không cần sơn lại theo thời gian, phù hợp khí hậu nắng mưa miền Nam. Sắt uốn thì đa dạng kiểu dáng, giá rẻ hơn ban đầu nhưng cần sơn chống gỉ định kỳ, nhất là nhà gần biển hoặc mưa nhiều."},
        {k:KP.khanh, d:D[2], h:5, best:true, t:"Nếu tính đường dài (5-10 năm) thì nhôm đúc tiết kiệm chi phí bảo trì hơn hẳn dù giá đầu tư ban đầu cao hơn — anh chị nào không có thời gian bảo trì định kỳ nên chọn nhôm đúc. Sắt uốn hợp với ai thích tự tay chăm sóc, sơn sửa định kỳ và ngân sách ban đầu hạn chế hơn."},
      ] },
    { asker:"Anh Thành Được · Vĩnh Cửu", qh:3, title:"Đất bao nhiêu m² thì đủ làm nhà 1 trệt 1 lầu hợp lý, không quá chật?",
      q:"Em đang tìm mua đất, chưa biết nên mua tối thiểu bao nhiêu m² để sau này xây 1 trệt 1 lầu thoải mái cho gia đình 4 người ạ.",
      ans:[
        {k:KP.tuan, d:D[0], h:6, best:true, t:"Với gia đình 4 người, đất tối thiểu nên từ 60-70m² trở lên (ví dụ 4x16m, 5x14m...) mới đủ bố trí công năng cơ bản (khách, bếp, 2-3 phòng ngủ, WC) mà không quá bí. Dưới mức này vẫn xây được nhưng phải tính toán kỹ, phòng ốc nhỏ gọn hơn. Ngoài diện tích, hình dạng lô đất (vuông vắn hay méo, mặt tiền rộng hay hẹp) cũng ảnh hưởng nhiều đến sự thoải mái khi ở."},
        {k:KP.nhan, d:D[2], h:2, t:"Đúng, mặt tiền rộng hơn 1 chút dù diện tích tổng bằng nhau cũng dễ bố trí và lấy sáng hơn đất hẹp ngang sâu."},
      ] },
    { asker:"Chị Thu Trang · Q.Thủ Đức", qh:2, title:"Bố trí phòng thờ ở vị trí nào trong nhà phố là hợp lý?",
      q:"Nhà em 3 tầng, đang phân vân đặt phòng thờ ở tầng nào và vị trí nào cho trang nghiêm mà vẫn tiện đi lại ạ.",
      ans:[
        {k:KP.bcv, d:D[0], h:6, best:true, t:"Phòng thờ thường được ưu tiên đặt ở tầng trên cùng (tầng cao nhất, gần sân thượng/mái) để đảm bảo sự trang nghiêm, thanh tịnh, tránh người qua lại ồn ào. Vị trí nên tránh ngay trên/dưới WC hoặc bếp, và không đặt sát đầu cầu thang đi thẳng vào. Có cửa sổ hoặc giếng trời nhỏ lấy sáng tự nhiên nhẹ nhàng cho không gian này là tốt nhất."},
        {k:KP.tri, d:D[2], h:2, t:"Bổ sung: nếu nhà chỉ 1-2 tầng, có thể đặt phòng thờ riêng ở góc yên tĩnh tầng trên cùng, ngăn cách nhẹ bằng vách lửng thay vì phải là 1 phòng kín hoàn toàn."},
      ] },
    { asker:"Anh Ngọc Sơn · Đức Hòa", qh:4, title:"Đất nông nghiệp muốn chuyển đổi để xây nhà ở cần thủ tục gì?",
      q:"Đất nhà em đang là đất nông nghiệp trồng cây lâu năm, em muốn chuyển sang đất ở để xây nhà. Quy trình thế nào ạ?",
      ans:[
        {k:KP.hphuc, d:D[0], h:7, best:true, t:"Cần làm thủ tục xin chuyển mục đích sử dụng đất tại Phòng Tài nguyên Môi trường quận/huyện trước tiên anh ạ — hồ sơ gồm đơn xin chuyển mục đích, giấy chứng nhận quyền sử dụng đất, và phải phù hợp với quy hoạch sử dụng đất của khu vực đó (nếu quy hoạch không cho phép chuyển thì không làm được). Sau khi được duyệt chuyển đổi và đóng tiền sử dụng đất chênh lệch, mới đủ điều kiện xin giấy phép xây dựng nhà ở. Quy trình này mất thời gian hơn đất thổ cư có sẵn, anh nên làm sớm trước khi có kế hoạch xây."},
        {k:KP.khanh, d:D[3], h:2, t:"Đúng vậy, nên hỏi trước ở Phòng TNMT xem đất mình có nằm trong quy hoạch được chuyển đổi không, tránh mất công chuẩn bị hồ sơ mà không được duyệt."},
      ] },
    { asker:"Chị Mỹ Duyên · Q.Gò Vấp", qh:2, title:"Lắp hệ thống lọc nước tổng cho cả nhà nên đặt ở đâu là hợp lý?",
      q:"Em muốn lắp máy lọc nước tổng đầu nguồn cho cả nhà dùng, chứ không chỉ lọc nước uống. Nên đặt vị trí nào và cần lưu ý gì khi thiết kế ạ?",
      ans:[
        {k:KP.klong, d:D[0], h:5, best:true, t:"Hệ lọc tổng nên đặt ngay sau đồng hồ nước, trước khi nước vào bồn chứa/bơm của nhà — vị trí thường ở khu kỹ thuật gần đường ống cấp nước vào nhà (sân trước hoặc hộp kỹ thuật). Cần báo KTS/thợ điện nước biết ý định này từ đầu để chừa sẵn không gian đặt máy + đường ống dễ tiếp cận khi cần bảo trì/thay lõi lọc, tránh phải đục phá sau này."},
        {k:KP.duong, d:D[2], h:2, t:"Thêm: nên có van tắt riêng trước và sau hệ lọc để dễ bảo trì mà không phải cắt nước toàn nhà."},
      ] },
    { asker:"Anh Bảo Long · Biên Hòa", qh:3, title:"Nhà có người già và trẻ nhỏ cần thiết kế đặc biệt gì để an toàn?",
      q:"Nhà em có ba mẹ già và con nhỏ 3 tuổi ở cùng. Nhờ các anh tư vấn thiết kế sao cho an toàn, tiện cho cả 2 nhóm tuổi ạ.",
      ans:[
        {k:KP.tri, d:D[0], h:8, best:true, t:"Vài nguyên tắc quan trọng cho nhà có cả người già và trẻ nhỏ: (1) hạn chế bậc cấp cao/cầu thang dốc — nếu có thể nên bố trí 1 phòng ngủ cho người già ở tầng trệt để đỡ leo cầu thang; (2) tay vịn cầu thang chắc chắn ở độ cao phù hợp cả 2 nhóm, có thêm tay vịn thấp cho trẻ nếu cần; (3) sàn nhà tắm/khu vực ẩm ướt dùng vật liệu chống trượt; (4) cửa/hành lang đủ rộng nếu sau này cần dùng xe lăn/khung tập đi; (5) ổ điện đặt cao hơn tầm với trẻ nhỏ ở khu vực sinh hoạt chung."},
        {k:KP.viet, d:D[2], h:2, t:"Bổ sung: ban công/lan can nên có song chắn khoảng cách hẹp, không để trẻ nhỏ chui lọt hoặc trèo qua được — nhiều nhà đẹp nhưng bỏ qua chi tiết an toàn này."},
      ] },
    { asker:"Chị Hải Yến · Q.12", qh:2, title:"Nhà mặt đường lớn xe cộ ồn ào, chọn vật liệu gì chống ồn hiệu quả?",
      q:"Nhà em mặt tiền đường lớn, xe chạy suốt ngày đêm rất ồn. Có vật liệu hay giải pháp thiết kế nào giảm tiếng ồn không ạ?",
      ans:[
        {k:KP.linh, d:D[0], h:6, best:true, t:"Vài giải pháp kết hợp hiệu quả: (1) cửa kính hộp 2-3 lớp cho mặt tiền (lớp không khí giữa 2 tấm kính cản âm tốt hơn kính đơn nhiều); (2) tường mặt tiền có thể làm dày hơn hoặc thêm lớp cách âm; (3) bố trí phòng ngủ/phòng cần yên tĩnh ở phía sau nhà, các không gian ít nhạy cảm với ồn (phòng khách, kho, cầu thang) ở mặt tiền để 'chắn' bớt tiếng ồn cho phía trong."},
        {k:KP.cuong, d:D[2], h:2, t:"Đồng ý, bố trí công năng hợp lý (phòng ngủ lùi sâu vào trong) nhiều khi hiệu quả chống ồn hơn cả vật liệu đắt tiền."},
      ] },
    { asker:"Anh Xuân Bách · Long An", qh:2, title:"Tường rào cổng nên xây liền khối với nhà chính hay tách riêng?",
      q:"Em đang thiết kế nhà, phân vân tường rào/cổng nên đồng bộ kiến trúc với nhà chính hay làm đơn giản tách biệt cho tiết kiệm ạ.",
      ans:[
        {k:KP.nam, d:D[0], h:5, best:true, t:"Về mặt thẩm mỹ nên đồng bộ phong cách với nhà chính (cùng tông màu, vật liệu, hoặc ít nhất là ngôn ngữ kiến trúc tương đồng) — nhìn tổng thể sẽ hài hòa và có giá trị hơn nhiều so với làm tách biệt kiểu 'mỗi thứ một kiểu'. Về chi phí thì làm đồng bộ ngay từ đầu (cùng lúc với nhà chính) thường tiết kiệm hơn làm sau vì tận dụng chung nhân công, vật tư, giàn giáo."},
        {k:KP.duy, d:D[2], h:2, t:"Đúng vậy anh, nhà em làm cổng sau khi nhà chính xong 2 năm, giờ nhìn không ăn nhập lắm, hơi tiếc."},
      ] },
  ];
}
